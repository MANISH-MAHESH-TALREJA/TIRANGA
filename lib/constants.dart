...
class Constants
{
  ...
  static const AppBarHistory           =    ["INDIAN HISTORY", "भारतीय इतिहास"];
  static const AppBarSongs             =    ["NATIONAL SONGS", "राष्ट्रीय गीत"];
  static const AppBarNameLetters       =    ["NAME LETTERS", "नाम के अक्षर"];

  static const AppBarShayari          =    ["INDIAN SHAYARI", "भारतीय शायरी"];
  static const AppBarStatus           =    ["VIDEO STATUS", "भारतीय वीडियो"];
  static const AppBarIndia            =    ["MY INDIA", "मेरा भारत देश"];
  ...
  static const OrangeColor            =     Color(0xFFFF9933);
  static const WhiteColor             =     Color(0xFFFFFFFF);
  static const BlueColor              =     Color(0xFF000080);
